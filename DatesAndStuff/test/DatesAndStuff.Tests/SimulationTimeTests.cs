...
namespace DatesAndStuff.Tests
{
    public sealed class SimulationTimeTests
    {
        ...
        {
            SimulationTime st = new SimulationTime(2012, 12, 12, 12, 12, 12);
            DateTime dt = new DateTime(2012, 12, 12, 12, 12, 12);

            SimulationTime st2 = st.AddMilliseconds(1);

            st2.Should().Be(st.NextMillisec);
        }
        ...
        public void GivenDateTimeAndSimulationTime_WhenAddingMilliseconds_ThenTimesShouldBeEqual()
        {
            ...
            st = st.AddMilliseconds(3);
            dt = dt.AddMilliseconds(3);

            st.Should().Be(new SimulationTime(dt));
        }
